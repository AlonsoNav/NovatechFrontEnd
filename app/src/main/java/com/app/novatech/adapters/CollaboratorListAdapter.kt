...
class CollaboratorListAdapter(private val colaboradores: List<Collaborator>) : RecyclerView.Adapter<ColaboradorViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ColaboradorViewHolder, position: Int) {
        ...
        holder.tvName.text = colaborador.name
